		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="photo video">
					<a href="https://www.youtube.com/embed/<?php echo get_post_meta( $post->ID, '_link_video', true ); ?>?autoplay=1" class="fancyvideo" rel="group">
						<div class="bg"><span>+</span></div>
						<iframe src="https://www.youtube.com/embed/<?php echo get_post_meta( $post->ID, '_link_video', true ); ?>?autoplay=0&showinfo=0&controls=0"></iframe>
					</a>
				</div>
			</div>
			<?php endwhile; ?> 
