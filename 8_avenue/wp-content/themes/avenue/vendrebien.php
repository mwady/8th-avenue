...
<section id="page_vendre_bien">
	<div class="container">
   <div class="row">
     <h2>Vous vendez votre bien ?</h2>
     <p>Merci de remplir ce formulaire, nous vous recontacterons dès que possible...</p>

     <div class="col-md-2 col-sm-12"></div>
     <div class="col-md-8 col-sm-12">
       <div class="titre col-md-12">
          <i class="fa fa-pencil"></i> Votre bien
        </div>
        <?php echo do_shortcode('[contact-form-7 id="54" title="Vendre un bien"]'); ?>
     </div>
   </div> 
  </div>
</section>
