...
/*
* Template Name: gestion locative
*/
...
<section id="gestionlocative">
  <div class="container">
    <div class="row">
      <h2>gestion locative</h2>
      <?php
        $gestion_locative = new WP_query("post_type=gestion_locative&order=asc&posts_per_page=1");
        while($gestion_locative->have_posts()){
        $gestion_locative->the_post();
      ?>
      <?php the_content(); ?>
      <?php } ?>
  ...
  <div class="text_eng">
    <div class="container">
      <div class="row">
        <?php
          $gestion_locative = new WP_query("post_type=gestion_locative&order=desc&posts_per_page=1");
          while($gestion_locative->have_posts()){
          $gestion_locative->the_post();
        ?>
        <?php the_content(); ?>
