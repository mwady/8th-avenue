...
/*
* Template Name: Maitrise d'oeuvre delegue
*/
...
<?php echo do_shortcode('[show_gd_mylist_list]'); ?>

<section id="page_mod">

	<div class="container">
		<div class="row">
			<h2>Maîtrise d'ouvrage déléguée (mod)</h2>
		</div>
		<div class="row four_mod">
			<?php
		        $mod = new WP_query("post_type=mod&order=asc&posts_per_page=4");
	...
	<img src="<?php bloginfo('template_directory') ?>/img/mod.jpg">
